...
def main():
    with open('vocareum_inputs/input5.txt') as infile:
    ...
    # score, results = minimax(0, board, True, color[0], float('-inf'), float('inf'), 2)
    ...
    # with open('output_board2.txt', 'w') as outfile:
    #     start = results[0][1]
